...
function showTasks(){
    ...
    for(let i = 0 ; i<values.length; i++){
        taskList.innerHTML += `<li>${values[i].name}</li><button id="btn-delete-task" onclick="deleteTask('${values[i].name}')"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16">
